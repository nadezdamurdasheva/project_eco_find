...
class MarksListTableViewController: UITableViewController,UISearchBarDelegate {
    ...
    let allMarks = [
        ...
        Marks(name: "09 ABS АБС-пластик, пластмасса", category: "Пластмассы" , desc: ". Корпуса мониторов/телевизоров и электроинструмента, кофеварки, сотовые телефоны, компьютерный пластик, распечатанные на 3D-принтере компоненты.", pict: UIImage(named: "sign9")!),
        ...
        Marks(name: "80 бумага (картон), различные материалы, композиционный материал", category: "Композиционные материалы" , desc: ". Упаковка от бургеров в Бургер Кинге, Мак Доналдсе.", pict: UIImage(named: "sign80")!),
        Marks(name: "81 PapPet бумага (картон), пластик, композиционный материал", category: "Композиционные материалы" , desc: ". Упаковки для кондитерских изделий, упаковка некоторых видов молока(тетрапак).", pict: UIImage(named: "sign81")!),
        Marks(name: "82 бумага (картон), алюминий, композиционный материал", category: "Композиционные материалы" , desc: ". Упаковка - картонный тубус покрытый алюминий-содержащей плёнкой.", pict: UIImage(named: "sign82")!),
        Marks(name: "83 бумага (картон), белая жесть, композиционный материал", category: "Композиционные материалы" , desc: "", pict: UIImage(named: "sign83")!),
        Marks(name: "84 C/PAP бумага (картон), пластик, алюминий, композиционный материал", category: "Композиционные материалы" , desc: ". Упаковки для сока(тетрапак), упаковка от чипсов Pringles.", pict: UIImage(named: "sign84")!),
        Marks(name: "85 бумага (картон), пластик, алюминий, жесть, композиционный материал", category: "Композиционные материалы" , desc: "", pict: UIImage(named: "sign85")!),
        Marks(name: "87 биоразлагаемый пластик, композиционный материал", category: "Композиционные материалы" , desc: ". Используется для ламината, закладки, визитки, флаеры, листовки.", pict: UIImage(named: "sign87")!),
        Marks(name: "90 пластик, алюминий, композиционный материал", category: "Композиционные материалы" , desc: ". Антистатические пакеты, упаковка еды быстрого приготовления, металлизированные пакеты.", pict: UIImage(named: "sign90")!),
        Marks(name: "91 пластик, белая жесть, композиционный материал", category: "Композиционные материалы" , desc: ". Крышка баночек - основа из жести изнутри покрытая пластиком, обеспечивающим герметизацию.", pict: UIImage(named: "sign91")!),
        Marks(name: "92 пластик, различные металлы, композиционный материал", category: "Композиционные материалы" , desc: ". Упаковка.", pict: UIImage(named: "sign92")!),
        Marks(name: "95 стекло, пластик, композиционный материал", category: "Композиционные материалы" , desc: "", pict: UIImage(named: "sign95")!),
        Marks(name: "96 стекло, алюминий, композиционный материал", category: "Композиционные материалы" , desc: "", pict: UIImage(named: "sign96")!),
        Marks(name: "97 стекло, белая жесть, композиционный материал", category: "Композиционные материалы" , desc: "", pict: UIImage(named: "sign97")!),
        Marks(name: "98 стекло различные металлы, композиционный материал", category: "Композиционные материалы" , desc: ". Банка из-под растворимого кофе с крышкой-клапаном, содержащей фольгу.", pict: UIImage(named: "sign98")!),
