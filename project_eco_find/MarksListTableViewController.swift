...
class MarksListTableViewController: UITableViewController,UISearchBarDelegate {
    ...
    var searchData = [Marks()]
     var searching = false
    let allMarks = [
        Marks(name: "01 PET полиэтилентерефталат (лавсан), пластмасса", category: "Пластмассы", desc: "", pict: UIImage(named: "sign1")!),
        Marks(name: "02 PE PE-HD PEHD HDPE полиэтилен высокой плотности (низкого давления), пластмасса", category: "Пластмассы", desc: "", pict: UIImage(named: "sign2")!),
        Marks(name: "03 PVC поливинилхлорид, пластмасса", category: "Пластмассы", desc: "", pict: UIImage(named: "sign3")!),
        Marks(name: "04 PE-LD PELD LDPE полиэтилен низкой плотности (высокого давления), пластмасса", category: "Пластмассы", desc: "", pict: UIImage(named: "sign4")!),
        Marks(name: "05 PP полипропилен, пластмасса", category: "Пластмассы" , desc: "", pict: UIImage(named: "sign5")!),
        Marks(name: "06 PS полистирол, пластмасса", category: "Пластмассы" , desc: "", pict: UIImage(named: "sign6")!),
        Marks(name: "07 O OTHER остальные виды пластика, пластмасса", category: "Пластмассы" , desc: "", pict: UIImage(named: "sign7")!),
        Marks(name: "09 ABS АБС-пластик, пластмасса", category: "Пластмассы" , desc: "", pict: UIImage(named: "sign9")!),
        Marks(name: "20 PAP PCB гофрированный картон, бумага", category: "Бумага" , desc: "", pict: UIImage(named: "sign20")!),
        Marks(name: "21 PAP прочий картон, бумага", category: "Бумага" , desc: "", pict: UIImage(named: "sign21")!),
        ...
        Marks(name: "40 FE сталь, металл", category: "Металлы" , desc: "", pict: UIImage(named: "sign40")!),
        Marks(name: "41 ALU алюминий, металл", category: "Металлы" , desc: "", pict: UIImage(named: "sign41")!),
        ...
        Marks(name: "51 FOR пробка, органический материал", category: "Органические материалы природного происхождения" , desc: "", pict: UIImage(named: "sign51")!),
        Marks(name: "60 TEX COT хлопок, органический материал", category: "Органические материалы природного происхождения" , desc: "", pict: UIImage(named: "sign60")!),
        Marks(name: "61 TEX джутовое волокно, органический материал", category: "Органические материалы природного происхождения" , desc: "", pict: UIImage(named: "sign61")!),
        ...
        Marks(name: "76 GLS GL хрусталь, стекло", category: "Стекло" , desc: "", pict: UIImage(named: "sign76")!),
